...
urlpatterns = [
    ...
    path('product_update_moderator/<int:pk>', never_cache(ProductUpdateModeratorView.as_view()), name='product_update_moderator'),
    path('product_delete/<int:pk>', ProductDeleteView.as_view(), name='product_delete'),
    path('versions/<int:pk>', VersionListView.as_view(), name='versions'),
    path('version_create/', never_cache(VersionCreateView.as_view()), name='version_create'),
    path('version_update/<int:pk>', never_cache(VersionUpdateView.as_view()), name='version_update'),
